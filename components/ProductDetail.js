    ...
    <SafeAreaView style={{ backgroundColor: "white" }}>
      ...
      <ScrollView ref={scrolls}>
        <View style={styles.productDetailInfo}>
          <Text style={styles.productDetailTitle}>{title}</Text>
          <Text style={styles.productDetailRating}>{"⭐".repeat(rating)}</Text>
          <Image
          ...
          <Text style={styles.productDetailPrice}>
            ...
            <Text style={{ fontWeight: "bold", color: "#B12704" }}>
              {price}
            </Text>
          </Text>
          ...
          <Text style={styles.productDetailDescription}>{description}</Text>
          <View style={styles.productDetailPriceDetail}>
            ...
            <View style={styles.productDetailGift}>
              <CheckBox />
              <Text>This order contains gift</Text>
            </View>
