...
export default class CardFormScreen extends PureComponent {
  ...
  componentDidMount() {
    ...
    //   publishableKey:
    //     "pk_test_51HlEFvDPfCWaAczP7KnxZB389coG9RjEqThhDtYskEEAw84KctGINrAmI8TMSJMrjQJnuYrQuxA0s2VjmOeR46Hd00ou6eOhDi",
  ...
  makePayment = async () => {
    ...
    axios({
      method: "POST",
      url: `http://192.168.1.10:7000/api/payments/mobile/create?total=${parseInt(
