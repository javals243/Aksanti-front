  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator
        ...
        // drawerContent={(props) => <CustomDrawerOption {...props} user={user} />}
      >
  ...
  return (
    <DrawerContentScrollView {...filteredProps}>
      <View style={styles.drawerHeader}>
        ...
        >
          ...
          <Text style={styles.drawerHeaderTitle}>
            Hello, {props.user ? props.user?.email.split("@")[0] : "Guest"}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      {props.user && (
        ...
        >
          <Text style={{ margin: 16, fontWeight: "bold", color: "#111" }}>
            Logout
          </Text>
        </TouchableOpacity>
      )}
